...
export const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_a31404aa",
      load: () => import("#nuxt-i18n/a31404aa" /* webpackChunkName: "locale_en_46json_a31404aa" */),
      cache: true
    }
  ],
  hr: [
    {
      key: "locale_hr_46json_a949a576",
      load: () => import("#nuxt-i18n/a949a576" /* webpackChunkName: "locale_hr_46json_a949a576" */),
      cache: true
    }
  ]
}
...
async function loadCfg(config) {
  ...
  import.meta.hot.accept("../i18n/i18n/locales/hr.json", async mod => {
    localeLoaders["hr"][0].load = () => Promise.resolve(mod.default)
    await useNuxtApp()._nuxtI18nDev.resetI18nProperties("hr")
  })
